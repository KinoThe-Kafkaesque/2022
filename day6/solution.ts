...
const star1 = (lengthOfSignal : number) => {
    ...
    for (let i = 0; i < message.length; i++) {
        ...
        // console.log(signalCheck.length , i+lengthOfSignal);
...
// // const message = [...inputData[0]]
// const star1 = (lengthOfSignal : number) => {
//     let signalCheck =  new Set()        
//     for (let i = 0; i < message.length; i++) {
//         const element = message[i]
//         signalCheck.add(element);
//         // console.log(signalCheck.size , i+lengthOfSignal);
        
//         if(signalCheck.size === lengthOfSignal) return i+lengthOfSignal;
//     }
// }
console.log(star1(4));
